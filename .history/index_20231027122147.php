...
require_once ("models/front/avis_model.php"); // Assurez-vous que le chemin vers AvisManager.php est correct
$avis_Manager = new AvisManager(); // Instanciez la classe AvisManager
