...
utilisant un délimiteur spécifié. Dans ce cas, la chaîne résultante de `filter_var($_GET['page'], FILTER_SANITIZE_URL)` est divisée en un tableau en utilisant le caractère "/" comme délimiteur.
