                ...
                case "connexion": $admin_controller->connexion();
                    ...
                    case "espacepro":
                        switch($url[2]){
                            ...
                            break;
                            case "modificationavis" : $espacepro_controller->modificationaviss(); 
                            break;
                            case "suppressionavis" : $espacepro_controller->suppressionavis(); 
                            break;
                            case "creationavis" : $espacepro_controller->creationavis(); 
                            break;
                            case "validationavis" : $espacepro_controller->validationviss(); 
                            break;
                            case "visualisationvoituresoccasions" : $espacepro_controller->visualisationvoituresoccasions(); //echo "voituresoccasions";
                            break;
                             case "modificationvoituresoccasions" : $espacepro_controller->modificationvoituresoccasionss(); //echo "modification";
                             break;
