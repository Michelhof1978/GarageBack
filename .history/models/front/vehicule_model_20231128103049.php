...
//La fonction `explode()` en PHP est utilisée pour diviser une chaîne de caractères en un tableau de sous-chaînes, en utilisant un délimiteur spécifié
 ...
 // echo ':value_' . str_replace(',', '', $value);
        ...
        $stmt->execute();
//PDO::FETCH_ASSOC est un mode de récupération qui indique à PDO de retourner un tableau associatif où les noms des colonnes de la base de données sont utilisés comme clés pour les valeurs correspondantes. Chaque ligne du tableau résultant représente un enregistrement de la base de données.
