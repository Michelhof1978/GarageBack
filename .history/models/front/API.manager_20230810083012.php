...
class APIManager extends Model{ //va hériter de Model et qui permettra la connexion à la BDD
    ...
    public function getDBPrestations(){
        ...
        $stmt->closeCursor();//On ferme le curseur
        return empty($prestations) ? [] : $prestations;//J ai rajouté empty pour dire que si pad de données, ça nous renvoie quand même un tableau vide, cela peut éviter certaines erreurs
        }
        }
