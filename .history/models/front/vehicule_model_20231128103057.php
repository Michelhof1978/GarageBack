...
associatif où les noms des colonnes de la base de données sont utilisés comme clés pour les valeurs correspondantes. Chaque ligne du tableau résultant représente un enregistrement de la base de données.
