...
public function getCarsByFilters($filters) { 
    ...
    if (isset($filters['famille'])) {//vérification des filtres et va ajouter au statement et va ajouter les AND 1 par 1
       // divise la valeur de ce filtre en un tableau en utilisant la virgule comme séparateur
        ...
        //Les emplacements nommés générés sont ensuite combinés en une chaîne unique séparée par des virgules à l'aide de la fonction implode. Cette chaîne est stockée dans la variable $namedPlaceholders.
