...
require_once(__ROOT__.'\models\model.php');
 require_once(__ROOT__.'\datagestion\vehicules_data.php');

class EspaceproManager extends Model {

        public function getVehicules() {
            $sql = "SELECT idVehicule, famille, marque, modele, annee, kilometrage, boitevitesse, energie, datecirculation, puissance, places, couleur, descriptions, prix FROM vehicule";
