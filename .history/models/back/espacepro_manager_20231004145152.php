...
////////////FIN SUPPRESSION
    ...
    $stmt->bindValue(":datecirculation", $datecirculation, PDO::PARAM_STR); // Assurez-vous que le type est correct
    ...
    $stmt->bindValue(":prix", $prix, PDO::PARAM_STR); // Assurez-vous que le type est correct
