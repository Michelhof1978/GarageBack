...
$puissance, $places, $couleur, $description, $prix, $imageCritere, $created_at){
    ...
    $created_at = $_POST['$datecirculation = $_POST['datecirculation']; // Récupération de la date du formulaire au format 'd-m-Y'
    $convertedDate = date("Y-m-d", strtotime($datecirculation)); // Converti la date au format 'Y-m-d'']; // Récupération de la date du formulaire au format 'd-m-Y'
    $convertedDate = date("Y-m-d", strtotime($datecirculation)); // Converti la date au format 'Y-m-d'
