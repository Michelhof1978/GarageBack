...
class EspaceproManager extends Model {
    ...
    public function getVoituresoccasions() {
        $sql = "SELECT vehicule_idVehiculer, vehicule_famille, vehicule_marque, vehicule_modele, vehicule_annee, vehicule_kilometrage, vehicule_boitevitesse, vehicule_energie, vehicule_datecirculation, vehicule_puissance, vehicule_places, vehicule_couleur, vehicule_description, vehicule_prix FROM vehicule";
