...
class EspaceproManager extends Model
{
    ...
    public function updateVehicule($ $imageVoiture, $famille, $marque, $modele, $annee, $kilometrage, $boitevitesse, $energie, $datecirculation, $puissance, $places, $couleur, $description, $prix, $imageCritere, $updated_at)
    {
