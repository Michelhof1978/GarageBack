...
// MODIFICATION PRESTATION
    public function updatePrestation($idPrestation, $nom,$description, $prix, $updated_at)  {
...
public function createPrestation($idPrestation, $nom,$description, $prix, $created_at)
{
...
$stmt->bindValue(":imagePrestation", $imageVoiture, PDO::PARAM_STR);
$stmt->bindValue(":nom", $famille, PDO::PARAM_STR);
$stmt->bindValue(":marque", $marque, PDO::PARAM_STR);
$stmt->bindValue(":modele", $modele, PDO::PARAM_STR);
$stmt->bindValue(":annee", $annee, PDO::PARAM_INT);
$stmt->bindValue(":kilometrage", $kilometrage, PDO::PARAM_INT);
