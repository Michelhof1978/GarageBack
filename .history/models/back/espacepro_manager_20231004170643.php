...
////////////FIN SUPPRESSION
    ...
    $required_fields = ['imageVoiture', 'famille', 'marque', 'modele', 'annee', 'kilometrage', 'boitevitesse', 'energie', 'datecirculation', 'puissance', 'places', 'couleur', 'description', 'prix'];
    foreach ($required_fields as $required_field) {
        if (!array_key_exists($required_field, $_POST)) {
            throw new Exception("Le champ $required_field est obligatoire");
        }
    }
    ...
    $model = Securite::secureHTML($_POST['model']);
    ...
    $stmt->bindValue(":datecirculation", $
