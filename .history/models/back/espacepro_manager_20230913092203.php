...
class EspaceproManager extends Model {
    ...
    public function updateVehicule($imageVoiture, $famille, $marque,
     ...
     $puissance, $places, $couleur, $description, $prix, $datecirculation, $imageCritere){
        $req = "UPDATE FROM `vehicule`set imageVoiture = :imageVoiture, famille = :famille,
         marque = :marque, model = :model, annee = :annee, kilometrage = :kilometrage, boitevitesse = :boitevitesse, energie = :energie, datecirculation = :datecirculation, puissance = :puissance, places = :places, couleur = :couleur, description = :description, prix = :prix, datecirculation = :datecirculation, imageCritere = :imageCritere WHERE idVehicule = :idVehicule";
