...
////////////FIN SUPPRESSION
   ...
   $required_fields = ['imageVoiture', 'famille', 'marque', 'modele', 'annee', 'kilometrage', 'boitevitesse', 'energie', 'datecirculation', 'puissance', 'places', 'couleur', 'description', 'prix', 'imageCritere'];
