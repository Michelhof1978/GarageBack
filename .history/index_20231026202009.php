                    ...
                    case "espacepro":
                        switch($url[2]){
                            ...
                            case "modificationavis" :
                                if (empty($url[3])) {
                                    throw new Exception("L'identifiant de l'avis est manquant");
                                }
                                $idAvis = $url[3];
                                $espacepro_controller->modificationavis($idAvis);
                            ...
                            break;
                            case "validationavis" : $espacepro_controller->validateavis($idAvis); 
                            break;
