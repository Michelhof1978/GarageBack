...
<form>
  ...
  <div class="form-group">
    ...
    <input type="int" class="form-control" id="annee" name="annee">
  </div>

  <div class="form-group">
    <label for="kilometrage" class="form-label">Kilometrage</label>
    <input type="int" class="form-control" id="kilometrage" name="kilometrage">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="int" class="form-control" id="puissance" name="puissance">
  </div>

  <div class="form-group">
    <label for="places" class="form-label">Places</label>
    <input type="int" class="form-control" id="places" name="places">
  </div>
