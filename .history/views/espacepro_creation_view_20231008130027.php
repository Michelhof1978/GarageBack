...
<form method="POST" action="<?= URL ?>back/espacepro/creationvoituresoccasions" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div>
        <input type="checkbox" id="utilitaire" name="famille[]" value="Utilitaire">
        <label for="utilitaire">Utilitaire</label>
    </div>
    <div>
        <input type="checkbox" id="berline" name="famille[]" value="Berline">
        <label for="berline">Berline</label>
    </div>
    <div>
        <input type="checkbox" id="familiale" name="famille[]" value="Familiale">
        <label for="familiale">Familiale</label>
    </div>
    <div>
        <input type="checkbox" id="citadine" name="famille[]" value="Citadine">
        <label for="citadine">Citadine</label>
    </div>
    <div>
        <input type="checkbox" id="suv" name="famille[]" value="Suv">
