...
//utile lorsqu'on'effectuer des redirections HTTP ou lorsque vous devez capturer la sortie pour la stocker dans une variable plutôt que de l'envoyer au navigateur
ob_start(); 
?>
