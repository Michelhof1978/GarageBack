...
<div class="form-group">
  <?php if(isset($vehicule['imageVoiture'])): ?>
    <img src="<?= URL ?>public/images/<?= $vehicule['imageVoiture'] ?>" style="width:100px;" />
  <?php endif; ?>
...
<div class="form-group">
  ...
  <div class="form-group">
  <?php if(isset($vehicule['imageCritere'])): ?>
    <img src="<?= URL ?>public/images/<?= $vehicule['imageCritere'] ?>" style="width:100px;" />
  <?php endif; ?>
  <label for="imageCritere" class="form-label">I Critere</label>
