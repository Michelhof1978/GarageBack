...
<div class="form-group">
     ...
     <!-- Pour voir l image en prévusialisation -->
...
<script>
function previewImageCritere(input) {
  if (input.files && input.files[0]) {
    var reader = new FileReader();

    reader.onload = function(e) {
      document.getElementById('imageCriterePreview').src = e.target.result;
      document.getElementById('imageCriterePreview').style.display = 'block';
    }
