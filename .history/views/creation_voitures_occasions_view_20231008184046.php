...
ob_start(); 
?>
<form method="POST" action="<?= URL ?>back/espacepro/creationvoituresoccasions">
  
  <div class="form-group">
    <label for="imageVoiture" class="form-label">Image Voiture</label>
    <input type="file" class="form-control-file" id="imageVoiture" name="imageVoiture">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="" class="form-control" id="imageCritere" name="imageCritere">
  </div>
