        ...
        <tbody>
            <?php foreach ($services as $service): ?>
                <tr>
                    ...
                    <td class="align-middle"><?= $service['prix'] ?></td>
                  
                    <td><?= isset($service['created_at']) ? $service['created_at'] : '' ?></td>
                    <td><?= isset($service['updated_at']) ? $service['updated_at'] : '' ?></td>
                    

                    <td>
                        <!-- Formulaire pour la modification -->
                        <form method="POST" action="<?= URL ?>back/espacepro/visualisationservice">
