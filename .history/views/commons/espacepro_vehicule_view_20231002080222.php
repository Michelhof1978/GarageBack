            ...
            <tbody>
                <?php foreach ($vehicules as $vehicule): ?>
                    ...
                    <tr>
                        ...
                        <form method="POST" action="<?= URL ?><back/>espacepro/voituresoccasions">
                        ...
                        <form method="POST" action="<?=URL?>back/espacepro/voituresoccasions" onsubmit="return confirm('Voulez-vous vraiment supprimer ?');">
                            <input type="hidden" name="idVehicule" value="<?= $vehicule['idVehicule'] ?>">
