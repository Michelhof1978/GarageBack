<?php ob_start(); ?>
 <!--pour commencer la temporisation de la sortie. Cela signifie que le contenu généré après cette instruction sera mis en mémoire tampon-->
            ...
            <tbody>
                <?php foreach ($vehicules as $vehicule): ?>
                    <?php
                        ...
                        if($_POST['idVehicule'] !== $vehicule['idvehicule'])  : // A gauche; l information qui a été posté et droite, c'est les informations de la bdd?>
                    <tr>
