    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="#">Freinage</a>
                <a class="dropdown-item" href="#">Entretien</a>
                <a class="dropdown-item" href="#">Vidange</a>
                <a class="dropdown-item" href="#">Pare-Brise</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= URL ?>back/">Voitures d'Occasions</a>
            </li>
            <li class="nav-item">
