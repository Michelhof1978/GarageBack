        ...
        <tbody>
            <?php foreach ($avis as $avi): ?>
                <tr>
                    ...
                    <td class="align-middle"><?= $avis['modele'] ?></td>
                    <td class="align-middle"><?= $avis['annee'] ?></td>
                    <td class="align-middle"><?= $avis['kilometrage'] ?></td>
                    <td class="align-middle"><?= $avis['boitevitesse'] ?></td>
                    <td class="align-middle"><?= $avis['energie'] ?></td>
                    <td class="align-middle"><?= $avis['datecirculation'] ?></td>
