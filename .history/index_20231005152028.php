                ...
                case "connexion": $admin_controller->connexion();
                    ...
                    case "espacepro":
                        switch($url[2]){
                            ...
                            break;
                             case "visualisationvoituresoccasions" : $espacepro_controller->modificationvoituresoccasions(); //echo "modification";
                             break;
                            case "visualisationvoituresoccasions" : $espacepro_controller->suppressionvoituresoccasions(); //echo "suppression";
                            break;
