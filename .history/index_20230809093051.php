        ...
        switch($url[0]){
            case "front" : //On vérifie la valeur de l'url 0, si elle est égale à front, on va vérifier la valeur de l'url 1.
                switch($url[1]){//On vérifie la valeur de l'url 1, si elle est égale à accueil, on affiche la page accueil.
                    ...
                    break;
                    case "prestations": 
                        if(empty($url[2])) throw new Exception ("La page n'existe pas");//On vérifie que l'URL contient bien 3 paramètres en ajoutant une auytre exeption.Si à l'indice 2 de l'url après le / n'existe pas aprés la page prestation, ds ce cas la je vais lever une erreur.
