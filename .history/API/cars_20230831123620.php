...
class Model{
    ...
    public function getCarsByFilters($filters) {
        ...
        $stmt->bindParam(':marquem',$filters['marque'], PDO::PARAM_STR);
        $stmt->bindParam(':kilometremin', $filters['kilometremin'], PDO::PARAM_STR);
        $stmt->bindParam(':even_budget', $filters[''], PDO::PARAM_STR);
