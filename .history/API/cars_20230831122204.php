...
class Model{
    ...
    public function getCarsByFilters($filters) {
        ...
        $stmt->bindParam(':marque', $nom filters, PDO::PARAM_STR);
        $stmt->bindParam(':kilometremin', $lieu filters, PDO::PARAM_STR);
        $stmt->bindParam(':even_budget', $budget filters, PDO::PARAM_STR);
        $stmt->bindParam(':even_etat', $etat filters, PDO::PARAM_STR);
        $stmt->bindParam(':even_frequence', $frequence filters, PDO::PARAM_STR);
