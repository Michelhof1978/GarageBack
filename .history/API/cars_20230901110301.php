...
if (isset($_GET['kilometremax'])) {
    $filters['kilometremax'] = intval($_GET['kilometremin']);
}

if (isset($_GET['anneemin'])) {
    $filters['anneemin']= $_GET['anneemin'];
}

if (isset($_GET['anneemax'])) {
    $filters['anneemax'] = $_GET['anneemax'];
}

if (isset($_GET['prixmin'])) {
    $filters['prixmin'] = $_GET['prixmin'];
}

if (isset($_GET['prixmax'])) {
    $filters['prixmax'] = $_GET['prixmax'];
}
