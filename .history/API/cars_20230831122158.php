...
class Model{
    ...
    public function getCarsByFilters($filters) {
        ...
        $stmt->bindParam(':marque', $nom fil, PDO::PARAM_STR);
        $stmt->bindParam(':kilometremin', $lieu fil, PDO::PARAM_STR);
        $stmt->bindParam(':even_budget', $budget fil, PDO::PARAM_STR);
        $stmt->bindParam(':even_etat', $etat fil, PDO::PARAM_STR);
        $stmt->bindParam(':even_frequence', $frequence fil, PDO::PARAM_STR);
