...
class Model{
    ...
    public function getCarsByFilters($filters) {
        ...
        $stmt->bindParam(':marque', $nom, PDO::PARAM_STR);
        $stmt->bindParam(':kilometremin', $lieu, PDO::PARAM_STR);
        $stmt->bindParam(':even_budget', $budget, PDO::PARAM_STR);
        $stmt->bindParam(':even_etat', $etat, PDO::PARAM_STR);
        $stmt->bindParam(':even_frequence', $frequence, PDO::PARAM_STR);
