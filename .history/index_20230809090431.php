...
require_once("controllers/front/API.controller.php");//On va récup le fichier API.controller.php qui contient la classe APIController. Je vais gérer une instance de ma classe contrôleur
