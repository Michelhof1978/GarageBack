        ...
        switch($url[0]){
            ...
            case "back" :
                ...
                case "connexion": $admin_controller->connexion();
                    ...
                    case "espacepro":
                        switch($url[2]){
                             case "espacepro" : $espacepro_controller->messagerie; //echo "messagerie";
                            break;
                            case "espacepro" : $espacepro_controller->avis; //echo "avis";
                            break;
                            case "espacepro" : $espacepro_controller->contenu; //echo "contenu";
                            break;
                            case "espacepro" : $espacepro_controller->horaire ;//echo "horaire";
                            break;
                            case "espacepro" : $espacepro_controller->voituresoccasions; //echo "voituresoccasions";
                            break;
                            case "espacepro" : $espacepro_controller->voituresovalidationSuppressionccasions; //echo "voituresoccasions";
                            break;
                            default : throw new Exception ("La page n'existe pas");
