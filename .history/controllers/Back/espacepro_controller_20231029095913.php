...
public function suppressionprestation() {
    if (isset($_POST['idPrestation']) && is_numeric($_POST['idPrestation']) && !empty($_POST['idPrestation'])) {
        $idVehicule = (int) Securite::secureHTML($_POST['idPrestation']);
        $imageVoiture = $this->espaceproManager->getimageVoiture($idPrestation);
        $imageCritere = $this->espaceproManager->getimageCritere($idPrestation);
