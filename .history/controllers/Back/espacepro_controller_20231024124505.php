...
public function visualisationavis()//Visualisation des voitures en stock
{
    if (Securite::verifAccessSession()) {
        $avis = $this->espaceproManager->getVoituresoccasions(); // Utilisez $vehicules au lieu de $voituresoccasions
        require_once(__ROOT__ . '\views\commons\espacepro_vehicule_view.php');
      } else {
         throw new Exception("Vous n'avez pas accès à cette page");
      }
