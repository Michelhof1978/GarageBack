...
class EspaceproController {
    ...
    public function suppression(){
        if(Securite::verifAccessSession()){
            ...
            $this->espaceproManager->deleteDBvehicule((int)Securite::secureHtml($_POST['$idVehicule']) ); //Int = obligé de tranformer les chaines de caract en entier pour la suppression , l'url doit être toujo
