...
//CREATION VEHICULE
 public function creationTemplate(){
    if (Securite::verifAccessSession()) {
        ...
        require_once "views/espacepro_ajout_avis_view.php";
      } else {
         throw new Exception("Vous n'avez pas accès à cette page");
      }
 }
...
Assurez-vous que cette méthode est correctement placée dans votre classe EspaceproController et que les autres méthodes de votre contrôleur sont également correctement définies. Assurez-vous également que les dépendances nécessaires sont incluses en haut du fichier (require_once).
