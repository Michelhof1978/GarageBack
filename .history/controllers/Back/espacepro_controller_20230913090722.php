...
public function modification(){ //Si l admin est loggé, on affichera la page sinon l évera une erreur
    ...
    if (Securite::verifAccessSession()){
        ...
        $model = Securite::secureHTML($_POST['modele']);
        $annee = Securite::secureHTML($_POST['annee']);
        $kilometrage = Securite::secureHTML($_POST['kilometrage']);
        ...
        $puissance = Securite::secureHTML($_POST['datecirculation']);
        $places = Securite::secureHTML($_POST['places']);
        ...
        $this->espacepro_manager->updateVehicule($idVehicule, imageVoiture, $famille, $marque, $model, $annee, $kilometrage, $boitevitesse, $energie, $datecirculation, $puissance, $places, $couleur, $description, $prix, $datecirculation, $imageCritere);
