...
public function modificationavis() {
    if (Securite::verifAccessSession()) {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // Vous n'avez pas besoin de récupérer la date de création depuis le formulaire
            // Vous pouvez mettre à jour la date `updated_at` directement dans le gestionnaire
