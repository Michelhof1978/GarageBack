...
public function modification() {
    if (Securite::verifAccessSession() && isset($_POST['idVehicule']) && !empty($_POST['idVehicule'])) {
        $idVehicule = (int) Securite::secureHTML($_POST['idVehicule']);
        ...
        $annee = (int) Securite::secureHTML($_POST['annee']);
        ...
        // Appelez la méthode de mise à jour dans le modèle
        ...
        // Redirigez l'utilisateur vers la page de visualisation des véhicules
        header('Location: ' . URL . 'back/espacepro/voituresoccasions');
        exit();
    } else {
        throw new Exception("Vous n'avez pas accès à cette page");
