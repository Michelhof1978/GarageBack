...
class EspaceproController {
    ...
    public function suppression(){
        if(Securite::verifAccessSession()){
            ...
            $this->espaceproManager->deleteDBvehicule((int)Securite::secureHtml($_POST['$idVehicule']) ); //Int = obligé de tranformer les chaines de caract en entier pour la suppression , l'url doit être toujours en chaine de caract donc obligé ici de le tranformer en int pour la suppression de l'id
