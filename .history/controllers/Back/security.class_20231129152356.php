...
class Securite
{
    ...
    {
        return htmlentities($string); //Convertir en html tous les caractères spéciaux comme par exemple les chevrons pour éviter ainsi certains problèmes comme des injections d url
