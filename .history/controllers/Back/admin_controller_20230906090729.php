...
echo "Mot de passe haché : $hashedPassword\n";
    ...
    // Définition des constantes __ROOT__ et URL si elles ne sont pas déjà définies
if (!defined('__ROOT__')) {
    define('__ROOT__', '/chemin/vers/votre/repertoire/root');
}

if (!defined('URL')) {
    define('URL', 'http://votre-site.com/');
}