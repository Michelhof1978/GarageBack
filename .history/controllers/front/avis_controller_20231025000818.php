<?php
require_once(__ROOT__.'/models/back/avis_manager.php'); // J'ai supposé que le fichier s'appelle avis_manager.php

class AvisController {
    private $avisManager; // Utilisation du nom correct
