...
class VehiculeController
{
    ...
    //Dans le constructeur de la classe, une instance de la classe VehiculeModel est créée. Cela suggère que le contrôleur utilise les fonctionnalités fournies par le modèle pour interagir avec les données des véhicules.
