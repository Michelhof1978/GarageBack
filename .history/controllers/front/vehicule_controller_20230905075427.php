...
//contrôleur qui va manipuler les données de véhicules dans le contexte d'une application. Elle utilise un modèle (VehiculeModel) pour accéder aux données et gérer les opérations liées aux véhicules. 
