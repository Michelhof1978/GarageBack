...
class AvisController {
    ...
    public function enregistrerAvis() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $result = $this->insertAvisDatabase($nom, $prenom, $note, $commentaire);
    ...
    private function insertAvisIntoDatabase($nom, $prenom, $note, $commentaire) {
        try {
            $pdo = $this->avisManager->getDBAvis(); // Utilisez votre méthode getDBAvis pour obtenir la connexion PDO.
