...
require_once("controllers/front/API.controller.php");//On inclut le fichier API.controller.php qui contient la classe APIController. Je vais gérer une instance
