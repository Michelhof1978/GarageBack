        ...
        switch($url[0]){
            case "front" : //On vérifie la valeur de l'url 0, si elle est égale à front, on va vérifier la valeur de l'url 1.
                switch($url[1]){//On vérifie la valeur de l'url 1, si elle est égale à accueil, on affiche la page accueil.
                    ...
                    break;
                    case "prestations": echo " page prestations".$url[2]." demandées";//On affiche la page prestation et on ajoute à l'indice 2 la prestation demandée avec .
                    break;
                    case "voituresFiltre": echo "page voituresFiltre";
                    break;
                    case "voitureFiche": echo "page voitureFiche".$url[2]." demandées";//On affiche la page voitureFiche et on ajoute à l'indice 2 la voiture selectionnée.
                    break;
