...
try{
    if(empty($_GET['page'])){
        ...
        switch($url[0]){
            case "front" : 
                switch($url[1]){
                    case "accueil": echo "données JSON des animaux demandées";
                    break;
                    case "prestations": echo "données JSON de l'animal ".$url[2]." demandées";
                    break;
                    case "voituresFiltre": echo "données JSON des continents demandées";
                    break;
                    case "voitureFiche": echo "données JSON des familles demandées";
                    break;
                    case "contact": echo "données JSON des familles demandées";
                    break;
                    case "avis": echo "données JSON des familles demandées";
                    break;
