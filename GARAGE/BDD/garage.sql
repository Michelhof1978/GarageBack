...
CREATE TABLE IF NOT EXISTS `GARAGE`.`administrateur` (
  ...
  `mot_de_passe` VARCHAR(150) BINARY NOT NULL,
  ...
  INDEX `fk_administrateur_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`horaires` (
  ...
  INDEX `fk_horaires_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`contactform` (
  ...
  INDEX `fk_contactform_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`prestation` (
  ...
  INDEX `fk_prestation_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`avis` (
  ...
  INDEX `fk_avis_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`vehicule` (
  ...
  INDEX `fk_vehicule_garage_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GARAGE`.`utilisateurs` (
  ...
  INDEX `fk_utilisateurs_garage1_idx` (`garage_idGarage` ASC) VISIBLE)
ENGINE = InnoDB;
